...
public class removestop {
	...
	String[] stopWrds={  "a", "about", "above", "above", "across", "after", "afterwards", "again", "against", "all",
			...
			"within", "without", "would", "yet", "you", "your", "yours", "yourself", "yourselves", "the", "a", "b",
			"c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", "t", "u", "v", "w",
			"x", "y", "z", "com","edu","you've"};

	public ArrayList<String> remove(ArrayList<String> before)
	{
		ArrayList<String> stopwords = new ArrayList<String>(Arrays.asList(stopWrds));
		ArrayList<String> words=new ArrayList<String>();
		
			
		for(String str:before)
		{
			String[] t=str.split(" |,|\\s+|\\-|\\:|\\/|@|\\.|\\(|\\)|\"|\\<|\\>|$|\\$|1|2|3|4|5|6|7|8|9|0|#|\\'|\\'s|ÿ|\\?|\\;|\\]|\\[|\\_|\\*|\\{|\\}|\\+|\\=|\\!|\\^|\\%|\\\\|\\`|\\||&|\\&|\\~");
			for(String p:t)
			{
				if(!(p.trim().isEmpty()))
				{
